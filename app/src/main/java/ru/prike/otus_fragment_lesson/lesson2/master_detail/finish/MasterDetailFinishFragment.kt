...
class MasterDetailFinishFragment : Fragment(R.layout.fragment_master_detail) {
    ...
    companion object {
        ...
        fun newInstance(item: Item?): MasterDetailFinishFragment = MasterDetailFinishFragment().apply {
